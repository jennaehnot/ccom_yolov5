...
''' STEP ZERO: Defining paths and loading the model'''
...
for video in buoy_vids:
    ...
    # path to images
    img_dir = '/home/field/jennaDir/dive_tools/annotated_vids/' + video + images
    img_filenames=os.listdir(img_dir)
    img_filenames.sort()

    # path to save inference dir
    inf_dir = '/home/field/jennaDir/dive_tools/annotated_vids/' + video + inference

    # gt path
    gt_lbl_dir = '/home/field/jennaDir/dive_tools/annotated_vids/' + video + labels
    ...
    for sz in img_sz: #for every img size we want to run inference at
        ...
        for file in img_filenames:
            ...
            frame_num = custom_funcs.imgname2frame(file)
            output_stats[file] = {
                'Frame': frame_num,
